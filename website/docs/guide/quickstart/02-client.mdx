...
<Tabs groupId="platform">
    ...
    <div class="w-64">
    !["Excalibur" Not Opened Alert](img/macos/not-opened.png)
    </div>
    ...
    2. Scroll down until you see a message like "Excalibur was blocked to protect your Mac." ![Blocked to Protect](img/macos/blocked-to-protect.png)
