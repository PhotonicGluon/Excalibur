...
You should also notice that the `security.opaque` table has been populated. These values are used for the [OPAQUE-3DH](/docs/server-api/authentication/index.mdx) authentication system, a more modern augmented password-authenticated key exchange (aPAKE) protocol.
