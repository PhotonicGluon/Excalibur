...
First, it is recommended to create a backup of the server files by zipping up the `excalibur-files` folder. For example, on Linux, you can run:

```bash
zip -r excalibur-files-backup.zip excalibur-files
```
