...
This guide will assume that the `0.7.x` version of the Excalibur server is installed. If you are using version `0.6.x`, please upgrade to `0.7.x` before proceeding. It is also recommended to create a backup of the server files by running:
