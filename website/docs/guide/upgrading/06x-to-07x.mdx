...
This update introduces some breaking changes to the server API. Please read the [changelog](/changelog/v0.7.1#server) for more information about what changed.
