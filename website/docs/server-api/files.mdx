...
Like with all file operations, this request needs to be authenticated. See the [WebSocket PoP token generation process](./subsequent-authentication.mdx#ws-pop).
