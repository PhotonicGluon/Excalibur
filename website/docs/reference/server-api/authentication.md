...
Once this initial authentication process is complete, future requests to secure endpoints will require the use of the authentication token obtained from the server. Do note that the body of the request and response will be encrypted. Read more in [Encrypted Requests and Responses](./encrypted-requests-and-responses.md).
