...
18. Server prepares [authentication token](./subsequent#authentication-token) in the form of a JSON Web Token (JWT) and encrypts it with the shared master key $K$ using AES-GCM-256.
