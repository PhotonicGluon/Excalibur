...
description: Specification for ExEF version 2 (deprecated).
---
...
This version has been deprecated in favour of v3 since Excalibur 0.3. This document is reproduced here only for posterity.
