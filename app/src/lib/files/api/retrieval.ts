...
export async function listdir(
    ...
    const directory = await ExEF.decryptResponse<Directory>(auth.authInfo!.e2eeKey!, response);
...
export async function downloadFile(
    ...
    const dataStream = ExEF.decryptStream(auth.authInfo!.e2eeKey!, response.body!);
