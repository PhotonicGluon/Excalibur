...
class Security(BaseModel):
    ...
    e2ee_comm_cache_size: int
    pop_nonce_cache_size: int
    pop_timestamp_validity_time: int
    ...
    @field_validator(
        "login_validity_time", "e2ee_comm_cache_size", "pop_nonce_cache_size", "pop_timestamp_validity_time"
    )
